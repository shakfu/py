...
cdef extern from "ext_proto.h":
    ...
    cdef void *inlet_append(t_object *op, void *who, t_symbol *s1, t_symbol *s2)
    cdef void *inlet_insert_after(t_object *op, void *who, t_symbol *s1, t_symbol *s2, void *previous_inlet)
    cdef void inlet_delete(void *x)
    cdef void *inlet_nth(t_object *x, long n)
    cdef long inlet_count(t_object *x)
